        ...
        <div>
            <div>
                ...
                <div className='flex mx-auto flex-col md:flex-row px-12 py-5 md:ml-28 ml-0'>
                    ...
                    <h1 className='animation-text text-sky-300 md:text-5xl text-2xl px-2 text-center font-bold'></h1>
                </div>    
            </div>
            <div>
                <h1 className='text-2xl md:font-semibold font-bold text-white  md:mt-10 text-center p-5'>Utilize Effective Learning To Reach Your Potential!</h1>
            </div>
