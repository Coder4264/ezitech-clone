  ...
  return (
    <div className='mt-24 mb-10'>
      ...
      <div className='flex flex-col md:flex-row justify-between items-center mx-auto w-8/12 mb-24'>
        <img className='w-full mb-20 md:mb-0 md:w-3/12' src="./src/assets/ss1.png" alt="" />
        <img className='w-full mb-20 md:mb-0 md:w-3/12' src="./src/assets/ss2.png" alt="" />
        <img className='w-full mb-20 md:mb-0 md:w-3/12' src="./src/assets/ss3.png" alt="" />
      </div>
