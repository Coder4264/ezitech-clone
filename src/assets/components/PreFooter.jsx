      ...
      <div className='flex items-center md:flex-row flex-col justify-between w-8/12 mx-auto mb-20 mt-40'>
        ...
        <div className='md:w-6/12 w-full flex flex-col gap-5'>
          ...
          <div className='flex gap-5'>
            <img src="https://ezitech.org/wp-content/uploads/2022/11/appstore-copy.webp" className='cursor-pointer w-4/12' alt="" />
            <img className='cursor-pointer w-4/12' src="https://stylemixthemes.com/masterstudy/tech/wp-content/uploads/sites/21/2021/02/%D0%98%D0%B7%D0%BE%D0%B1%D1%80%D0%B0%D0%B6%D0%B5%D0%BD%D0%B8%D0%B5_22.png" alt="" />
          </div>
        </div>
      </div>
